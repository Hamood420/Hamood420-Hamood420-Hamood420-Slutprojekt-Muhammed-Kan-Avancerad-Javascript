...
import KöpSida from "./modules/KopSida.jsx";
...
function WebShop() {
    ...
    return (
        ...
        {LoggedIn == 'KopSida' && <KöpSida updateLogInStatus={updateLogInStatus} stateName={stateName} totalProducts={totalProducts} totalCost={totalCost1} totalPhones={totalPhones}/>}
